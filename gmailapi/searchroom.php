<?php include 'con1.php';?>  
       <?php include 'con.php';?>
<?
$k1=$_POST['kddsfwefwcwefvwvefwep'];
$k2=$_POST['kddsfwefwcwefvwvefweq'];
if($k2=='empty' || $k1=='')
{
                ...
                <div class="dis-contact">
                  <h4>Contact Information</h4>
                        <form action="#" method="post">
                          ...
                          <input type="text" name="phone" class="phone" placeholder="send message.." required="">
                          <div class="d-c">  
...
$(document).ready(function(){
   ...
   var k2="<?php echo $k2 ?>";
        $.ajax({
            url:"fetch_data3.php",
            method:"POST",
            data:{action:action,price:price,per:per,fur:fur,k1:k1,k2:k2,minimum_price:minimum_price, maximum_price:maximum_price, catagary:catagary,ptype:ptype,properties:properties,gender:gender},
